...
public class DropboxFileUploaderTest extends TestCase {
    ...
    public void testRemoteFileMissing() {
        ...
        DropboxFileUploader uploader = new DropboxFileUploader(dropboxapi, dropboxFiles1, false);

        uploader.pushFiles();

        assertEquals("Status should be SUCCESS", DropboxFileStatus.SUCCESS, uploader.getStatus());
    ...
    public void testRemoteFileConflict() {
        ...
        assertEquals("Should have 1 file", 1, uploader.getFiles().size());
        assertEquals("Status should be CONFLICT", DropboxFileStatus.CONFLICT, dbFile1.getStatus());
        assertEquals(remoterev1, dbFile1.getLoadedMetadata().rev);
    }
    ...
    public void testRemoteFileOverwrite() {
        ...
        DropboxFileUploader uploader = new DropboxFileUploader(dropboxapi, dropboxFiles1, true);
    ...
    public void testBothFilesMissing() {
        ...
        DropboxFileUploader uploader = new DropboxFileUploader(dropboxapi, dropboxFiles2, false);
    ...
    public void testSecondRemoteFileConflict() {
        ...
        assertEquals("Should have 2 file", 2, uploader.getFiles().size());
        assertEquals("Status should be FOUND", DropboxFileStatus.FOUND, dbFile1.getStatus());
        assertEquals("Status should be CONFLICT", DropboxFileStatus.CONFLICT, dbFile2.getStatus());
    }
    ...
    public void testBothRemoteFilesOverwrite() {
        ...
        DropboxFileUploader uploader = new DropboxFileUploader(dropboxapi, dropboxFiles2, true);
