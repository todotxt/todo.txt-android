...
public class TaskTest extends TestCase {
    ...
    public void testConstructor_withLink() throws MalformedURLException {
        ...
        assertEquals(1, task.getId());
        assertEquals("A simple test with an http://www.url.com", task.getOriginalText());
    ...
    public void testConstructor_withMultipleLinks() throws MalformedURLException {
    ...
    public void testConstructor_withInterspersedLinks() throws MalformedURLException {
    ...
    public void testUpdate_simpleToPriority() {
        ...
        assertFalse(task.isDeleted());
        assertFalse(task.isCompleted());
        assertEquals("Another simple test with a priority curve ball", task.inScreenFormat());
        assertEquals(expectedResult, task.inFileFormat());
        assertEquals("", task.getCompletionDate());
    }
