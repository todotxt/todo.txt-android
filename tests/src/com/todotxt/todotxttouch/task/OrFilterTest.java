/**
 *
 * Todo.txt Touch/src/com/todotxt/todotxttouch/task/OrFilterTest.java
 *
...
public class OrFilterTest extends TestCase {
    public void testNoFilters() {
        ...
        assertTrue("apply was not true", orFilter.apply(new Task(1, "(A) abc 123")));
    }
    ...
    public void testMultipleFilters_matchesOnlyOne() {
        ...
        assertTrue("apply was not true", orFilter.apply(new Task(1, "(A) hello world")));
    }
    ...
    public void testMultipleFilters_matchesNone() {
        ...
        assertFalse("apply was not false", orFilter.apply(new Task(1, "(B) hello world")));
    }
