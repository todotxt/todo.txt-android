/**
 *
 * Todo.txt Touch/src/com/todotxt/todotxttouch/util/CursorPositionCalculator.java
 *
 ...
 * A simple utility class for updating the text in an EditText box. Keeps the
 * cursor position in the same position.
 *
