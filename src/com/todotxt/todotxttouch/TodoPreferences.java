...
public class TodoPreferences {
    ...
    public boolean isManualModeEnabled() {
        try {
            long period = Long.parseLong(m_prefs.getString(periodic_sync_pref_key, "0"));
    ...
    public void storeFilters(Collection<Priority> prios, Collection<?> contexts,
            Collection<?> projects, String search, Collection<?> summaries) {
        Editor editor = m_prefs.edit();
     ...
     * upgraded.
     * 
     * @param versionCode version code in the same format as in the manifest
     *            file.
     */
