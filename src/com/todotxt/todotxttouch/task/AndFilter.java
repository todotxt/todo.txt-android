/**
 *
 * Todo.txt Touch/src/com/todotxt/todotxttouch/task/AndFilter.java
 *
...
/**
 * A composite filter.  All subfilters must be true for this filter to be true.  Returns
 * true when there are no subfilters.
 */
