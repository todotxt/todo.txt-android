...
class TaskBagImpl implements TaskBag {
    ...
    public TaskBagImpl(Preferences preferences, LocalTaskRepository localRepository, RemoteTaskRepository remoteTaskRepository) {
    ...
    public void addAsTask(String input) {
        try {
            reload();
            Task task = new Task(tasks.size(), input, (preferences.shouldPrependDate ? new Date() : null));
            tasks.add(task);
            pushToRemote();
    ...
    public void disconnectFromRemote() {
        // TODO remove local purge, for now application doesn't function without logging into dropbox
    ...
    public static class Preferences {
        ...
        public static class Builder {
             ...
             *
             * @param shouldPrependDate the value to set
             * @return this builder
             */
             ...
             *
             * @param useWindowsLineBreaks the value to set
             * @return this builder
             */
