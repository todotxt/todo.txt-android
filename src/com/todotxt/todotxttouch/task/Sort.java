...
public enum Sort {
     ...
     * <p>(A), (B), (C), ..., (Z), (NO PRIORITY), (COMPLETED)</p>
     * <p>If tasks are of the same priority level, they are sorted by task id ascending</p>
     * <p>Note: this comparator imposes orderings that are inconsistent with equals.</p>
     */
    PRIORITY_DESC(0, new Comparator<Task>() {
        ...
        public int compare(Task t1, Task t2) {
            ...
            if(t1.getPriority() == Task.NO_PRIORITY && t2.getPriority()==Task.NO_PRIORITY) {
                return Sort.ID_ASC.getComparator().compare(t1, t2);
            }
            ...
            int result = new Character(t1.getPriority()).compareTo(new Character(t2.getPriority()));
            if(result==0) {
    ...
    private final static String TAG = Sort.class.getSimpleName();
    ...
    /**
     * Retrieves the sort selection by its id, default to PRIORITY_DESC if
     * no matching sort is found
