...
class LocalFileTaskRepository implements LocalTaskRepository {
    ...
    final static File TODO_TXT_FILE = new File(Environment.getExternalStorageDirectory(), "data/com.todotxt.todotxttouch/todo.txt");
    ...
    public void store(ArrayList<Task> tasks) {
        TaskIo.writeToFile(tasks, TODO_TXT_FILE, preferences.useWindowsLineBreaks);
    }
}
